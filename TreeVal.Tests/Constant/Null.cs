...
public class Null
{
    ...
    [ 
        ...
        ExpressionTreeEvaluator.Create(node => node.Constant(EValue.EqualTo<Child?>(null))),
        ExpressionTreeEvaluator.Create(node => node.Constant(EValue.ReferenceEqualTo<Other>(null))),
        ExpressionTreeEvaluator.Create(node => node.Constant(EValue.ReferenceEqualTo<Other?>(null))),
        ...
        ExpressionTreeEvaluator.Create(node => node.Constant(TChild, EValue.EqualTo<Child?>(null))),
        ExpressionTreeEvaluator.Create(node => node.Constant(TChild, EValue.ReferenceEqualTo<Other>(null))),
        ExpressionTreeEvaluator.Create(node => node.Constant(TChild, EValue.ReferenceEqualTo<Other?>(null))),
        ...
        ExpressionTreeEvaluator.Create(node => node.Constant(EType.EqualTo(TChild), EValue.EqualTo<Child?>(null))),
        ExpressionTreeEvaluator.Create(node => node.Constant(EType.EqualTo(TChild), EValue.ReferenceEqualTo<Other>(null))),
        ExpressionTreeEvaluator.Create(node => node.Constant(EType.EqualTo(TChild), EValue.ReferenceEqualTo<Other?>(null))),
        ...
        ExpressionTreeEvaluator.Create(node => node.Constant(EType.EqualTo<Child>(), EValue.EqualTo<Child?>(null))),
        ExpressionTreeEvaluator.Create(node => node.Constant(EType.EqualTo<Child>(), EValue.ReferenceEqualTo<Other>(null))),
        ExpressionTreeEvaluator.Create(node => node.Constant(EType.EqualTo<Child>(), EValue.ReferenceEqualTo<Other?>(null))),
        ...
        ExpressionTreeEvaluator.Create(node => node.Constant(EType.Is(TBase), EValue.EqualTo<Child?>(null))),
        ExpressionTreeEvaluator.Create(node => node.Constant(EType.Is(TBase), EValue.ReferenceEqualTo<Other>(null))),
        ExpressionTreeEvaluator.Create(node => node.Constant(EType.Is(TBase), EValue.ReferenceEqualTo<Other?>(null))),
        ...
        ExpressionTreeEvaluator.Create(node => node.Constant(EType.Is<Base>(), EValue.EqualTo<Child?>(null))),
        ExpressionTreeEvaluator.Create(node => node.Constant(EType.Is<Base>(), EValue.ReferenceEqualTo<Other>(null))),
        ExpressionTreeEvaluator.Create(node => node.Constant(EType.Is<Base>(), EValue.ReferenceEqualTo<Other?>(null)))
        // @formatter:on
    ];
