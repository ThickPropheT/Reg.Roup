...
public static class IgnoreBoxingEvaluatorExtensions
{
    ...
    public static VisitorNodeFactory IgnoreBoxing(this VisitorNodeFactory factory)
        => new IgnoreBoxingVisitorNodeFactory(factory);

    private class IgnoreBoxingVisitorNodeFactory : VisitorNodeFactory
    {
        // private readonly VisitorNodeFactory _source;
        // private readonly IEvaluatorBuilder<UnaryExpression> _ignored;

        public IgnoreBoxingVisitorNodeFactory(VisitorNodeFactory source)
        {
            throw new NotImplementedException("this was broken by splitting specialized builder methods out to extensions");
            // _source = source;
    ...
    // private class IgnoreNode : EvaluatorBuilderBase
    // {
